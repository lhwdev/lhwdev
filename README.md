...
개발을 좋아하는 이현우라고 합니다!  
23학번, 2학년으로 성균관대학교 소프트웨어학과에 다니고 있습니다.
...
![All stars](https://img.shields.io/badge/dynamic/json?logo=github&label=받은%20⭐%20수&style=for-the-badge&query=%24.stars&url=https://api.github-star-counter.workers.dev/user/lhwdev&color=f2e81c)
...
- &thinsp;<img src="https://avatars.githubusercontent.com/u/39462049?s=100" width="16" height="16" />&thinsp; [**System Consultant Group**](https://scg.skku.ac.kr): 성균관대학교의 일부 서비스들을 관리하는 _최고의_ 학생자치단체.  
  ...
  * **정보통신대학원 졸업논문시스템** 2023: 제가 처음으로 참여한 학교 프로젝트입니다. 많이 참여하지는 못했지만, 클라이언트의 니즈를 파악하고 판단하는 법을 익히고 있습니다.

- ⛏️ **railx**: 마인크래프트의 유명한 모드 Create의 Addon입니다. 온갖 철도 관련 기능을 추가했어요.

- 📃 **llang**: 재미로 그냥 만들고 있는 프로그래밍 언어 명세 & 파서 등 툴링 코드입니다.
